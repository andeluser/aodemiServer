...
//ルイーズアッシュ
public class b19 implements CardAbility {
	...
	public HashMap<String, Object> auto(String battleID, String playerId, int fieldNumber) throws Exception {
		...
		//自分のユニットのATKをHPと同じにする
		int curATK = fieldDto.getCur_hp() - (fieldDto.getPermanent_atk() + fieldDto.getCur_atk());
		//ターン増加でHPと同じとなるように調整
		fieldDto.setTurn_atk(curATK);
		//DBを更新
		fieldDao.update(fieldDto);

		detailMap.put("tupATK", curATK);
